...
angular.module('templates-main', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put("template/register.html",
    ...
    "			<div class=\"goButton\" ng-click=\"forCallback()\" style=\"margin-top:50px\">已有账号直接登录</div>\n" +
    "		</div>\n" +
    "	</ion-content>\n" +
    "</ion-view>");
